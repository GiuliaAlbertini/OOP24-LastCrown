...
public class PlayableCharacterImpl extends GenericCharacterImpl implements PlayableCharacter {
     ...
     */
    public PlayableCharacterImpl(final String name, final String type, final Requirement requirement,
    ...
    final int energyToPlay, final double speedMultiplier, final int actionRange) {
        super(name, requirement, attack, health, atckRecoveryTime, speedMultiplier);
        this.type = type;
    ...
    @Override
    public final int getCopiesPerRound() {
